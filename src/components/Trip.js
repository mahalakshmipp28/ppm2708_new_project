    ...
    <div className="trip">
      ...
      <div className="tripcard">
        ...
        <TripData
          ...
          text="France, in Western Europe, encompasses medieval cities, airplane villages and Mediterranean beaches. Paris,its capital, is famd for its fashion houses, classical art museums including the Louvre and monuments like the Eiffel Tower."
        />
      </div>
    </div>
  );
